...
/* joins: find all product names, p
roduct prices, and products ratings that have a rating of 5 */
...
/* joins: find the product name, total # sold, and total price sold,
 ...
 SELECT p.Name AS Product, COUNT(s.Quantity) AS TotalQuantity, SUM(s.PricePerUnit * s.Quantity) AS TotalValue
 FROM products AS p
 INNER JOIN sales AS s
